...
-- 数据库: `food_order`
--
CREATE DATABASE IF NOT EXISTS `food_order` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `food_order`;
...
INSERT INTO `canteen` (`phone`, `name`, `x`, `y`) VALUES
('123547888445', '手工水饺', 23.06290054321289, 113.39800262451172),
('13546899774', '73街', 23.062000274658203, 113.39800262451172),
('15784955887', '食物方', 23.0669002532959, 113.39900207519531);
