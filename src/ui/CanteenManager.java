...
public class CanteenManager extends javax.swing.JFrame implements
		...
		jTable1.addMouseListener(new MouseAdapter(){
			public void mousePressed(MouseEvent me){
				...
				if(SwingUtilities.isRightMouseButton(me)){
					...
					JMenuItem item1 = new JMenuItem("È·ÈÏ¶©µ¥");
					item1.addActionListener(new ActionListener(){

						@Override
						public void actionPerformed(ActionEvent arg0) {
							if(JDBC.modifyOrderStatus(id, "ÒÑÈ·ÈÏ") > 0){
								jTable1.setValueAt("ÒÑÈ·ÈÏ", r, c+1);
							}
						}
						
					});
					JMenuItem item2 = new JMenuItem("È·ÈÏÅäËÍ");
					item2.addActionListener(new ActionListener(){

						@Override
						public void actionPerformed(ActionEvent arg0) {
							if(JDBC.modifyOrderStatus(id, "ÒÑÅäËÍ") > 0){
								jTable1.setValueAt("ÒÑÅäËÍ", r, c+1);
							}
						}						
					});
					pm.add(item1);
	...
	private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {
		// TODO add your handling code here:
		if (mIsLogin) {
			jButton4.setText("ÒÑ¾­×¢Ïú");
			mIsLogin = false;
			jButton5.setText("µÇÂ¼");
			jLabel1.setText("ÇëµÇÂ¼~~~");
		}
	}
	...
	private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {
		...
		if (b) {
			...
			String str = "<html>" + "Ãû×Ö:" + tempCanteenInfo.getName() + "<br>"
					+ "µç»°:" + tempCanteenInfo.getPhone() + "<br>" + "Latitude:"
					+ tempCanteenInfo.getLatitude() + "<br>" + "Longitude:"
					+ tempCanteenInfo.getLongitude() + "<br>" + "</html>";
			jLabel1.setText(str);
			jButton5.setText("ÒÑ¾­µÇÂ¼");
			jButton4.setText("×¢Ïú");
	...
	private javax.swing.table.DefaultTableModel mTableModal = new javax.swing.table.DefaultTableModel(
			null, new String[] { "¶©µ¥ID", "×´Ì¬", "×Ü¼Û¸ñ", "Ê³ÎïÃû³Æ", "ÊýÁ¿", "¼Û¸ñ" });
